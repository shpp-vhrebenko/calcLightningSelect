...
class Room extends Polygon {
    ...
    protected $button_id;
    public $number;
    function __construct($name,$area_coords,$scaling,$button_id,$fill = 'rgb(234,234,234)', $border_color = "rgb(255,0,0)", $bord_width = 1) 
    {
      parent::__construct($fill, $border_color, $bord_width);
      $this->name=$name;
