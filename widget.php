          ...
          <div class="row">
            <div class="col-xs-8 col-md-7 box-content">
              ...
              <form class="form-horizontal"
                ...
                <div class="form-group">
                  <label for="search_user_lamp" class="col-sm-5 control-label" data-toggle="tooltip" data-placement="left" data-container="body" title="Выбирете наименование светильника" data-i18n="form.label_1">Поиск</label>
                  <div class="col-sm-7">                    
                    <input type="text" data-provide="typeahead" name="search_user_lamp"  class="form-control search_lamp" id="search_user_lamp" /> 
                  </div>
                </div>                
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="heightRoom" class="col-sm-5 control-label" data-i18n="form.label_3">Высота помещения, м</label>
                  <div class="col-sm-7">                    
                    <input class="room input-sm" type="number" id="heightRoom" name="heightRoom" placeholder="2.5" min="0.0" step="0.1" required/>
                  </div>
                </div>
                <div class="form-group">
                  <label for="lampsWorkHeight" class="col-sm-5 control-label" data-toggle="tooltip" data-placement="left" data-container="body" title="Высота на которой необходимо обеспечить требуемое освещение" data-i18n="form.label_4">Рабочая поверхность, м</label>
                  <div class="col-sm-7">                    
                    <input  type="number" class="room input-sm" id="lampsWorkHeight" name="lampsWorkHeight" placeholder="0.8" min="0.0" step="0.1" required />
                  </div>
                </div> 
                <div class="form-group">
                  <label for="reflectionCoef" class="col-sm-5 control-label" data-toggle="tooltip" data-placement="left" data-container="body" title="Коэффициент отражения поверхностей" data-i18n="form.label_5">Коэф. отражения</label>
                  <div class="col-sm-7">                    
                    <select class="room input-sm select-sm" id="reflectionCoef" name="reflectionCoef" required>
                      ...
                      <option data-i18n="selectRCoef.opt_1" value="0,0,0">Пол-0%, стены-0%, потолок-0%</option>            
                      <option data-i18n="selectRCoef.opt_2" value="30,30,10">Пол-30%, стены-30%, потолок-10%</option>
                      <option data-i18n="selectRCoef.opt_3" value="50,30,10">Пол-50%, стены-30%, потолок-10%</option>
                      <option data-i18n="selectRCoef.opt_4" value="50,50,10">Пол-50%, стены-50%, потолок-10%</option>
                      <option data-i18n="selectRCoef.opt_5" value="70,50,20">Пол-70%, стены-50%, потолок-20%</option>
                      <option data-i18n="selectRCoef.opt_6" value="80,30,10">Пол-80%, стены-30%, потолок-10%</option>
                      <option data-i18n="selectRCoef.opt_7" value="80,50,30">Пол-80%, стены-50%, потолок-30%</option>
                      <option data-i18n="selectRCoef.opt_8" value="80,80,30">Пол-80%, стены-80%, потолок-30%</option>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  <label for="safetyFactor" class="col-sm-5 control-label" data-toggle="tooltip" data-placement="left" data-container="body" title="Запас освещенности" data-i18n="form.label_6">Коэф. запаса</label>
                  <div class="col-sm-7">                    
                ...
                <div class="form-group">
                  <label for="requiredIllumination" class="col-sm-5 control-label" data-toggle="tooltip" data-placement="left" data-container="body" title="по ГОСТ" data-i18n="form.label_7">Треб. освещ. лк</label>
                  <div class="col-sm-7">                    
                    <select class="room input-sm select-sm" id="requiredIllumination" name="requiredIllumination" required>
                      ...
                      <option data-i18n="selectRILum.opt_6" value="50">Склады в зоне хранения товара</option>
                      <option data-i18n="selectRILum.opt_7" value="200">Склады в зоне приема товара</option>
                      ...
                      <option data-i18n="selectRILum.opt_10" value="200">Объединенные залы и буфеты</option>
                      <option data-i18n="selectRILum.opt_11" value="400">Торговые залы магазинов</option>
                      <option data-i18n="selectRILum.opt_12" value="200">Конференц-залы и залы заседаний</option>
                      <option data-i18n="selectRILum.opt_13" value="500">Проектные и конструкторские бюро</option>
                      <option data-i18n="selectRILum.opt_14" value="300">Читальные залы</option>
                      <option data-i18n="selectRILum.opt_15" value="300">Учебные аудитории и классы</option>                      
                ...
                <div class="form-group">
                  <label for="customRequiredIllumination" class="col-sm-5 control-label" data-i18n="form.label_8">Треб. освещ. лк</label>
                  <div class="col-sm-7">                    
            ...
            <div class="col-xs-4 col-md-5 image-box" id="image-box">
              ...
              <div class="row">
                <button type="button" class="btn btn-sm btn-warning col-xs-12 col-md-12 set_data" id="set_data" data-i18n="header.add_lamp">              
        ...
        <div class="col-xs-12 col-md-12 table-box" id="table-box">          
          ...
          <div class="row user-result-panel" id="user-result-panel">                    
            <div class="dropup col-md-1 half-col-md view-pdf">
              <button class="btn btn-sm btn-default dropdown-toggle" type="button" data-toggle="dropdown" data-i18n="button.pdf">PDF
              <span class="caret"></span></button>
              <ul class="dropdown-menu">
                <li><a type="button" class="view-pdf__item" id="view_pdf_listLightingDevicesInRooms" data-i18n="doc.doc_1">Ведомость осветительных приборов по помещениям</a></li>
